  ...
  return (
    <main className="privacy-page">
      <article>
        ...
        <section><h2>What is collected</h2><p>When you submit the order form or message a connected StepFresh Facebook or WhatsApp business account, LeadPilot stores the available name or channel identifier, contact details you provide, enquiry message, source, and workflow information created to help the business respond.</p></section>
